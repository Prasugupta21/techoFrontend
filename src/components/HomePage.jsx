...
const HomePage = () => {
  ...
  return (
    <div className="w-full">
      {/* Hero Section */}
      <div className="relative w-full min-h-screen bg-gradient-to-b from-indigo-50 to-white overflow-hidden">
        {/* Background Pattern */}
        <div className="absolute inset-0 w-full bg-grid-slate-900/[0.04] bg-[size:20px_20px]" />
